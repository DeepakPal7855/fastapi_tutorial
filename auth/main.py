...
SECRET_KEY = "u9lfNHNtbzBprF85Bk1hgWZaCEjS9d1_QbfG9mYVWY4"
ALGORITHM = "HS256"
...
def get_current_user(token: str = Depends(oauth2_scheme)):
    credential_exception = HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail="Could not not validated credential", headers={"WWW.Authenticate": "Bearer"})
...
def protected_route(current_user: dict = Depends(get_current_user)):
    return {"Messege": f"Hello, {current_user['username']} | You accesssed a protected route"}
